...
<head>
	...
	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=AW-17391537004"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
	...
	<script>
		...
		fbq('init', '1334935930899015');
		fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
			src="https://www.facebook.com/tr?id=1334935930899015&ev=PageView&noscript=1" /></noscript>
	<!-- End Meta Pixel Code -->

	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-72WJBXT4SV"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
